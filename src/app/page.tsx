...
import { Sun, Sparkles, Shield, Zap, TrendingUp, Flame, ArrowRight } from "lucide-react";
  ...
  return (
    <div className="min-h-[calc(100vh-12rem)] flex flex-col items-center">
      ...
      <div className="fixed top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] pointer-events-none">
        <div className="absolute inset-0 bg-gradient-radial from-amber-500/10 via-orange-500/5 to-transparent rounded-full blur-3xl animate-pulse-glow" />
        <div className="absolute inset-[20%] bg-gradient-radial from-amber-500/20 to-transparent rounded-full blur-2xl" />
      </div>

      {/* Hero Section */}
      <div className="text-center mb-12 relative z-10 pt-8">
        {/* Animated Badge */}
        <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-gradient-to-r from-amber-500/10 to-orange-500/10 border border-amber-500/20 mb-8 animate-float-up backdrop-blur-sm">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 tracking-tight">
          ...
          <span className="relative inline-block">
            <span className="bg-gradient-to-r from-amber-400 via-orange-500 to-amber-500 bg-clip-text text-transparent animate-gradient-flow bg-[length:200%_auto]">
              Helios
            </span>
            <Flame className="absolute -top-2 -right-6 h-6 w-6 text-amber-500 animate-fire-flicker" />
          </span>
        </h1>
        ...
        <div className="flex items-center justify-center gap-4 mb-12">
          <Link
            href="/pools"
            className="group flex items-center gap-2 px-6 py-3 rounded-2xl bg-zinc-800/80 border border-white/10 text-white font-medium hover:bg-zinc-700/80 hover:border-amber-500/30 transition-all duration-300"
          >
      ...
      <div className="relative z-10 w-full max-w-md mx-auto">
        {/* Glow behind card */}
        <div className="absolute inset-0 bg-gradient-to-b from-amber-500/20 via-orange-500/10 to-transparent blur-3xl -z-10 scale-150" />
        <TradeTabs />
      ...
      <div className="mt-20 w-full max-w-5xl mx-auto px-4">
        <div className="text-center mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">
            Why <span className="text-amber-500">Helios</span>?
          </h2>
        ...
        <div className="glass-card rounded-3xl p-8">
          <div className="text-center">
            ...
            <p className="text-zinc-400">
              Real statistics will be available on <span className="text-amber-500 font-medium">Flare Mainnet</span> launch
            </p>
          </div>
        </div>
      </div>
...
function FeatureCard({
  ...
  return (
    <div className="group p-6 rounded-2xl bg-zinc-900/50 border border-white/5 hover:border-amber-500/20 transition-all duration-300 hover:bg-zinc-900/80 hover:shadow-lg hover:shadow-amber-500/5">
